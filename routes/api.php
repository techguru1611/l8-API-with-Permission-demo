...
Route::get('assets/{id}/render', 'Api\Assets\RenderFileController@show');
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::get('/{id}', 'Api\Users\UsersController@show');
        Route::put('/{id}', 'Api\Users\UsersController@update');
        Route::patch('/{id}', 'Api\Users\UsersController@update');
        Route::delete('/{id}', 'Api\Users\UsersController@destroy');
    });

    Route::group(['prefix' => 'roles'], function () {
        Route::get('/', 'Api\Users\RolesController@index');
        Route::post('/', 'Api\Users\RolesController@store');
        Route::get('/{id}', 'Api\Users\RolesController@show');
        Route::put('/{id}', 'Api\Users\RolesController@update');
        Route::patch('/{id}', 'Api\Users\RolesController@update');
        Route::delete('/{id}', 'Api\Users\RolesController@destroy');
    });
